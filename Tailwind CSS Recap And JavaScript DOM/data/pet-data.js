...
for (let singlePetData of petData) {
  ...
  const singleCard = `
      ...
      <div class="border rounded-lg">
        <figure>
          <img
            class="rounded-lg"
            src="${singlePetData.image}"
            alt="Image of ${singlePetData.category} - ${singlePetData.pet_name}, ${singlePetData.breed}"
          />
        </figure>
        <article class="p-4 space-y-2 mt-2">
          <h3 class="text-xl font-bold">${singlePetData.pet_name}</h3>
          <p><i class="bx bx-table-cells-large"></i> Breed: ${singlePetData.breed}</p>
          <p><i class="bx bx-calendar-alt"></i> Birth:${singlePetData.date_of_birth} </p>
          <p><i class="bx bx-${singlePetData.gender}"></i> Gender: ${singlePetData.gender}</p>
          <p><i class="bx bx-dollar-circle"></i> Price: ${singlePetData.price}</p>
        </article>
      </div>
  `
